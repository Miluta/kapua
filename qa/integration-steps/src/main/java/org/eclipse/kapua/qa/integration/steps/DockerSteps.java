...
public class DockerSteps {
     ...
     * @param dockerImage              full name of image (e.g. "kapua/kapua-broker:1.2.0-FIX-PLUGIN-SNAPSHOT")
    ...
    private ContainerConfig getDbContainerConfig() {
        ...
        return ContainerConfig.builder()
                ...
                .image("kapua/kapua-sql:1.2.0-FIX-PLUGIN-SNAPSHOT")
                .build();
    }
    ...
    private ContainerConfig getEventBrokerContainerConfig() {
        ...
        return ContainerConfig.builder()
                ...
                .image("kapua/kapua-events-broker:1.2.0-FIX-PLUGIN-SNAPSHOT")
                .build();
    }
